 ...
 * EIG. This method uses the <<operator of the AbstractInstance classes. Be sure
 * to defined that method to generate a proper representation. The method
 * generates a file for each instance in the given front of solutions.
 * @param front
 */
template <typename S>
