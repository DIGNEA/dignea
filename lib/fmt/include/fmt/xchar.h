...
// std::basic_string<char_t<S>> to reduce the symbol size.
        ...
        auto format(const S &format_str,
            ...
            const auto &vargs = fmt::make_args_checked<Args...>(format_str,
                                                                args...);
        ...
        template<typename Locale, typename S, typename... Args,
                ...
                FMT_ENABLE_IF(detail::is_locale<Locale>::value&&
                                      detail::is_exotic_char<Char>::value)>
        inline auto
        format(const Locale &loc, const S &format_str, Args &&... args)
        -> std::basic_string<Char> {
        ...
        template<typename OutputIt, typename S, typename... Args,
                ...
                FMT_ENABLE_IF(
                        ...
                        detail::is_exotic_char<Char>::value)>
        inline auto
        format_to(OutputIt out, const S &fmt, Args &&... args) -> OutputIt {
        ...
        template<
                ...
                detail::is_exotic_char<Char>::value>
        inline auto
        format_to(OutputIt out, const Locale &loc, const S &format_str,
                  Args &&... args) ->
