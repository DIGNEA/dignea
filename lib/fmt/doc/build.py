...
versions = ['1.0.0', '1.1.0', '2.0.0', '3.0.2', '4.0.0', '4.1.0', '5.0.0',
            '5.1.0', '5.2.0', '5.2.1', '5.3.0', '6.0.0', '6.1.0', '6.1.1',
            '6.1.2', '6.2.0', '6.2.1', '7.0.0', '7.0.1', '7.0.2', '7.0.3',
            '7.1.0', '7.1.1', '7.1.2', '7.1.3', '8.0.0']
...
class Pip:
    ...
    def install(self, package, commit=None):
        ...
        if commit:
            package = 'git+https://github.com/{0}.git@{1}'.format(package,
                                                                  commit)
...
def build_docs(version='dev', **kwargs):
    ...
    noisy_warnings = [
        'warning: (Compound|Member .* of class) (' + '|'.join(
            internal_symbols) + \
        ') is not documented.',
